<?php
$zapytanie = "INSERT INTO kandydat_wyniki_maturalne (username, `ID_kandydata`, `pesel`, `ID_przedmiotu`, `Wynik_pisemny`, `Wynik_ustny`, `Klasa_dwujezyczna`, `data_aktualizacja`, `uzytkownik_aktualizacja`)
VALUES (:username, :ID_kandydata, :pesel, :ID_przedmiotu, :Wynik_pisemny, :Wynik_ustny, Klasa_dwujezyczna, :data_aktualizacja, :uzytkownik_aktualizacja)";
